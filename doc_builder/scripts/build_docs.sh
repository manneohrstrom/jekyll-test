...
BUNDLE_GEMFILE=${THIS_DIR}/../Gemfile JEKYLL_ENV=production bundle exec jekyll build --url ${URL} --baseurl ${URLPATH} --config ${THIS_DIR}/../jekyll/_config.yml --source ${TMP_BUILD_FOLDER}/markdown_src --destination ${OUTPUT}
